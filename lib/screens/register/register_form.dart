    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            IconButton(
              icon: Image.asset('assets/icons/google.png', height: 36),
              onPressed: () => _socialRegisterNotImplemented('Google'),
              tooltip: 'הרשמה עם Google',
            ),
            const SizedBox(width: 12),
            IconButton(
              icon: Image.asset('assets/icons/facebook.png', height: 36),
              onPressed: () => _socialRegisterNotImplemented('Facebook'),
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'סיסמה',
                            labelStyle: GoogleFonts.assistant(),
                            helperText: '6-12 תווים, אותיות באנגלית ומספרים',
